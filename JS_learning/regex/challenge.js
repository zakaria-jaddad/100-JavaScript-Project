...
let url8 = 'https://github.com/zakaria-jaddad/100-JavaScript-Project/blob/main/JS_learning/re1gex/char_classes.js'
...
let re1=/(https?:\/\/)?(www\.)?\w{1,}\.[a-z]{1,}:?(.{1,})?/ig;
...
console.log(url6.match(re1));
console.log(url7.match(re1));
console.log(url8.match(re1));
console.log(url9.match(re1));
console.log(url10.match(re1));
